...
pyp.plot(plot_Erange , plot_ff_type0 , color='r' , label="Type 0: Thin Shell" )
pyp.plot(plot_Erange , plot_ff_type1 , color='g' , label="Type 1: Hard Sphere" )
pyp.plot(plot_Erange , plot_ff_type2 , color='b' , label="Type 2: Gaussian" )
pyp.plot(plot_Erange , plot_ff_type3 , color='c' , label="Type 3: Helm" )
